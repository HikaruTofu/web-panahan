...
if ($resultStats) {
    while ($row = $resultStats->fetch_assoc()) {
        // Calculate Dominant Category in PHP
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="logout-section">
            <a href="../actions/logout.php" class="logout-btn" onclick="return confirm('Yakin ingin logout?')">
                🚪 Logout
            </a>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="username-container">
                ...
                <img src="../assets/img/angzay.png" alt="Profile" class="profile-logo"
                        ...
                        <?php if (empty($daftarAtlet)): ?>
                            <div style="text-align: center; padding: 20px; color: #7f8c8d;">
                                <i class="fas fa-user-slash"
                                    style="font-size: 32px; opacity: 0.3; margin-bottom: 10px;"></i>
                                <p style="font-size: 13px;">Belum ada atlet terdaftar</p>
                            </div>
                        <?php else: ?>
                            <?php foreach ($daftarAtlet as $index => $namaAtlet): ?>
                                <div class="stat-list-item"
                                    onclick="showAthleteStats('<?php echo htmlspecialchars($namaAtlet, ENT_QUOTES); ?>')">
                    ...
                    <div class="stat-list">
                        ...
                        <?php else: ?>
                            <?php foreach ($daftarClub as $index => $namaClub): ?>
                                <div class="stat-list-item"
                                    onclick="showClubMembers('<?php echo htmlspecialchars($namaClub, ENT_QUOTES); ?>')">
                    ...
                    <div class="stat-list">
                        ...
                        <?php else: ?>
                            <?php foreach ($atletBerprestasi as $index => $atlet): ?>
                                <div class="stat-list-item"
                                    onclick="showAthleteStats('<?php echo htmlspecialchars($atlet['nama'], ENT_QUOTES); ?>')">
                                    <div class="number"><?php echo $index + 1; ?></div>
                                    <div class="name">
                                        <?php echo htmlspecialchars($atlet['nama']); ?><br>
                                        <small style="color: #7f8c8d;">📍
                                            <?php echo htmlspecialchars($atlet['club'] ?: 'No Club'); ?></small>
                                        <small style="color: #27ae60; margin-left: 8px;">🏆
                                            <?php echo $atlet['juara1']; ?>x</small>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                            ...
                            <?php foreach ($atletKurangPrestasi as $index => $atlet): ?>
                                <div class="stat-list-item"
                                    ...
                                    <div class="name">
                                        ...
                                        <small style="color: #7f8c8d;">📍
                                            <?php echo htmlspecialchars($atlet['club'] ?: 'No Club'); ?></small>
                                        <small style="color: #e67e22; margin-left: 8px;">📊 Kat.
                                            <?php echo $atlet['kategori']; ?></small>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
