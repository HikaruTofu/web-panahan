...
<head>
    ...
    <style>
        ...
        .stats-card.kategori-a {
            border-color: var(--success-color);
        }

        .stats-card.kategori-b {
            border-color: var(--primary-color);
        }

        .stats-card.kategori-c {
            border-color: var(--accent-color);
        }

        .stats-card.kategori-d {
            border-color: var(--warning-color);
        }

        .stats-card.kategori-e {
            border-color: #6b7280;
        }
...
<body>
    <div class="container-fluid py-4">
        ...
        <div class="kategori-legend">
            <h5 class="mb-3"><i class="fas fa-info-circle me-2"></i>Sistem Kategorisasi (Dinamis Berdasarkan Jumlah
                Peserta)</h5>
            <div>
                <span class="legend-item bg-success text-white">🏆 Kategori A: Top 30% DAN Peringkat 1-3 (Sangat
                    Baik)</span>
                <span class="legend-item bg-primary text-white">🥈 Kategori B: Top 31-40% DAN Peringkat 4-10
                    (Baik)</span>
                ...
                <span class="legend-item bg-secondary text-white">📈 Kategori E: Bottom 20% / Belum Bertanding
                    (Pemula)</span>
            </div>
