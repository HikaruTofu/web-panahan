...
<body class="min-h-screen bg-slate-50 flex items-center justify-center p-4">
    <!-- Main Card -->
    <div class="w-full max-w-md bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <!-- Header Section -->
        <div class="px-8 pt-10 pb-8 text-center">
            <!-- Logo Icon -->
            <div class="w-14 h-14 bg-archery-100 rounded-xl flex items-center justify-center mx-auto mb-6">
                <i class="fas fa-bullseye text-archery-600 text-xl"></i>
            </div>

            <!-- Title -->
            <h1 class="text-2xl font-bold text-slate-900 mb-2">Masuk ke Sistem Panahan</h1>
        ...
        <div class="px-8 pb-10">
            ...
            <?php if (isset($_GET['message']) && $_GET['message'] == 'logout_success'): ?>
                <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg flex items-start gap-3">
                    ...
                    <p class="text-sm text-emerald-700">Logout berhasil! Silakan login kembali.</p>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" id="loginForm" class="space-y-5">
                <!-- Username Field -->
                <div>
                    <label for="name" class="block text-sm font-medium text-slate-700 mb-2">Nama Pengguna</label>
                    <div class="input-wrapper relative">
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-archery-500 focus:border-transparent focus:bg-white transition-all duration-200"
                ...
                <div>
                    ...
                    <div class="input-wrapper relative">
                        ...
                        <input
                            ...
                            id="password"
                            name="password"
                            class="w-full pl-11 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-archery-500 focus:border-transparent focus:bg-white transition-all duration-200"
                        ...
                        <button
                            type="button"
                            id="togglePassword"
                            class="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-archery-600 transition-colors"
                        >
                ...
                <div class="text-right">
                    <a href="#" class="text-sm text-slate-400 hover:text-archery-600 transition-colors">
                        Lupa Password?
                    </a>
                </div>
